      ...
      var members = {
        ...
        updateStage: function () {
          ...
          if (stage === 'customer') {
            ...
            if ($('.data-checkout-stage').data('customer-type') === 'registered') {
              ...
              if ($('.payment-information').data('payment-method-id') === 'CREDIT_CARD' || $('.payment-information').data('payment-method-id') === 'pablo_payment_card') {
            ...
            $.ajax({
              ...
              success: function (data) {
                ...
                if (data.error) {
                  ...
                  var actionUrl = data.continueUrl + `?ID=${data.orderID}`;
                  var redirect = $('<form>')
        ...
        initialize: function () {
          ...
          $('input[name$="paymentMethod"]', plugin).on('change', function () {
            $('.credit-card-form').toggle($(this).val() === 'CREDIT_CARD' || $(this).val() === 'JEY_PAYMENT_CARD');
          });
